                ...
                <div class="content">
                    ...
                    <?php 
                        if (isset($_POST['submit'])) {
                            ...
                            // if (isset($_FILES['image_card']['error']) && $_FILES['image_card']['error'] === UPLOAD_ERR_OK) {
                            //     $imageFileName = $_FILES['image_card']['name'];
                            //     $imageTmpName = $_FILES['image_card']['tmp_name'];
                            //     $imageSize = $_FILES['image_card']['size'];
                            //     $imageType = $_FILES['image_card']['type'];

                            //     // Validate image type and size (optional)
                            //     $allowedTypes = ['image/jpeg', 'image/png', 'image/gif'];
                            //     if (!in_array($imageType, $allowedTypes)) {
                            //     echo "Error: Invalid image type. Only JPEG, PNG, and GIF are allowed.";
                            //     exit;
                            //     }

                            //     if ($imageSize > 1024 * 1024 * 5) { // 5MB limit (optional)
                            //     echo "Error: Image size exceeds 5MB.";
                            //     exit;
                            //     }

                            //     // Generate a unique filename (optional)
                            //     $uniqueFilename = uniqid() . "." . pathinfo($imageFileName, PATHINFO_EXTENSION);
                            ...
                            //         // - Perform image manipulation (resize, etc.)
                            //         $image_card = $uniqueFilename;
